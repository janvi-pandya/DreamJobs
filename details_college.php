		...
		<center><h1>COLLEGE DETAILS</h1>
			<table  border="2" width="800px">
				<?php
					...
					$u_id=$_REQUEST['id'];
					$sql="SELECT * FROM college where `u_id`='$u_id';";
			...
			<a href="colleges_approval.php?email=<?php echo $row['email']; ?>"><input type="button" name="approval" value="APPROVE REQUEST"></a>
			<a href="delete_College.php?email=<?php echo $row['email']; ?>"><input type="button" name="delete" value="REJECT REQUEST"> </a>
