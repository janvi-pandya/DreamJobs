...
<center><br><h1><b>APPROVED JOB APPLICANT PROFILES</b></h1>
			<table border="2" cellspacing="0" style="text-align: center;align-content: center;height: 50px; width: 100%;">
				...
				<tr>
					...
					<th><a href="details_student_com.php?c_id=<?php echo $row_Std['email']; ?>&enroll_no=<?php echo $row_Std['enroll_no']; ?>&jid=<?php echo $row['job_id']; ?>"><input style="width:100px;" type="button" name="details" value="DETAILS"></a></th>
