...
<body>
		...
		<center><h1>STUDENT DETAILS</h1>
			...
			<th><a href="students_job_approval.php?enroll_no=<?php echo $enroll_no; ?>&jid=<?php echo $_REQUEST['jid']; ?>"><input type="button" name="approval" value="APPROVE APPLICATION"></a></th>
			<a href="reject_student_jobs_app.php?enroll_no=<?php echo $enroll_no; ?>&jid=<?php echo $_REQUEST['jid']; ?>"><input type="button" name="reject" value="REJECT APPLICATION"> </a>
