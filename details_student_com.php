...
<body>
		...
		<center><h1>STUDENT DETAILS</h1>
			...
			<th><a href="offer_job.php?enroll_no=<?php echo $enroll_no; ?>&jid=<?php echo $_REQUEST['jid']; ?>"><input type="button" name="approval" value="OFFER THE JOB"></a></th>
			<a href="reject_job_offer_confirm.php?enroll_no=<?php echo $enroll_no; ?>&jid=<?php echo $_REQUEST['jid']; ?>"><input type="button" name="reject" value="REJECT"> </a>
